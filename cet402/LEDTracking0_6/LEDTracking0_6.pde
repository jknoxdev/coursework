 ...
 // int prev_x ;
  ...
  for(int i=0 ; i<b.length ; i++)
  {
   ...
   // triangle( 25,220  ,  35,230  ,  45,220 ); 
      ...
      /*  left   */ if ( ( curr_x ) < ( prev_x-3 ) ) {  triangle( 10,205  ,  20,195  ,  20,215 ); }
      /*  right  */ if ( ( curr_x ) > ( prev_x+3 ) ) {  triangle( 50,195  ,  60,205  ,  50,215 ); } 
      /*  up     */ if ( ( curr_y ) < ( prev_y-3 ) ) {  triangle( 25,190  ,  35,180  ,  45,190 ); }
      /*  down   */ if ( ( curr_y ) > ( prev_y+3 ) ) {  triangle( 25,220  ,  35,230  ,  45,220 ); }
